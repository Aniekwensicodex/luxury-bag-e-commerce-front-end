      ...
      <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-serif mb-4">Sign In</h1>
            <p className="text-muted-foreground font-sans mb-2">
              Welcome back to Luxury Bags
            </p>
            <p className="text-xs text-muted-foreground font-sans">
              New customers? <Link href="/register" className="text-gold hover:underline">Create an account</Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="rememberMe" className="text-sm font-sans cursor-pointer">
                Remember me
              </label>
            </div>
          ...
          <div className="relative my-8">
            <Separator />
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-background px-4 text-sm text-muted-foreground font-sans">
              or
            </span>
          </div>
